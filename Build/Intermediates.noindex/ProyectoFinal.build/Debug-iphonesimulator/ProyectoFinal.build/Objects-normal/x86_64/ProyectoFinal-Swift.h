...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ProyectoFinal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13ProyectoFinal11AppDelegate")
...
- (IBAction)makeCall:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC13ProyectoFinal20SecondViewController")
@interface SecondViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified butDerechosHumanos;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified butBienestar;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified butCalidad;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified butGeriantria;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified butInclusion;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified butNewTecnologia;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC13ProyectoFinal16TabBarController")
...
SWIFT_CLASS("_TtC13ProyectoFinal34TableViewControllerActividadesCult")
@interface TableViewControllerActividadesCult : UITableViewController
...
SWIFT_CLASS("_TtC13ProyectoFinal27ViewControllerInfoActividad")
...
- (void)didReceiveMemoryWarning;
- (IBAction)butRegresar:(UIButton * _Nonnull)sender;
- (IBAction)addToCalendar:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
